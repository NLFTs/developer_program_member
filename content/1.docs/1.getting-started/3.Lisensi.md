---
title: Lisensi
description: Lisensi NLFTs diberikan kepada para pengembang untuk membangun ekosistem yang lebih baik.
navigation:
...
icon: i-lucide-gavel
target: _blank
to: https://nlfts.dev/getting-started/protokol
---
**DOKUMEN MENGIKAT:** Pergunakan Lisensi ini dengan bijak dan sesuai dengan peraturan perundang-undangan yang berlaku. Pelanggaran terhadap ketentuan ini dapat berakibat pada tindakan hukum formal.
::

### PENGANTAR LISENSI

Lisensi ini diterbitkan dan diberikan apa adanya (*as is*) kepada seluruh kontributor NLFTs, baik yang beroperasi di dalam maupun di luar lingkup organisasi resmi. NLFTs memberikan izin penggunaan lisensi ini untuk diterapkan pada repositori pribadi maupun organisasi, dengan catatan tetap mematuhi batasan-batasan yang telah ditetapkan.

Penggunaan lisensi ini membawa tanggung jawab penuh bagi pemegang akses. Syarat mutlak yang harus dipatuhi adalah aset ini tidak diperkenankan untuk disalahgunakan, diperjualbelikan secara ilegal, atau didistribusikan tanpa otoritas resmi. Perlu ditekankan bahwa lisensi ini diberikan tanpa garansi dalam bentuk apa pun; seluruh risiko penggunaan berada pada tangan kontributor. Detail ketentuan hukum mengikat dapat dibaca pada bagian di bawah ini.

---

### :u-icon{name="i-lucide-file-signature" class="inline-block mr-2 text-blue-400"} OFFICIAL DIRECTIVE
```bash [LICENSE]
